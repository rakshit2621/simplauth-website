        ...
        <div className="flex flex-col gap-4 items-start justify-center">
          ...
          <div className="flex flex-col gap-4 items-center justify-center">
            ...
            <p>
              ...
              providing credentials. The user must supply two things: email (or
              username) and password within the Provider. Keep the Provider
              exactly as shown, and send a request to the backend as
              demonstrated below.
            </p>
