    ...
    >
      <div className="flex-col justify-start items-start pl-4">
        ...
        <div className="flex flex-col gap-4 items-start justify-center">
          ...
          It prompts you to enter your email and password when you visit the website.
          </p> 
          {/* ---------------------------------Autologin------------------------------------ */}
          ...
          <div className="flex flex-col gap-4 items-center justify-center">
            ...
            Ensure that EmailPassPrisma is defined in the Prisma schemas. 
          ...
          <div className="flex flex-col gap-4 items-center justify-center">
            ...
            The user must supply two things: email and password within the Provider. 
            ...
            . The user credentials — email and password as string 
            ...
            {` { message: "Invalid email", status: "failed" }`}. If the
