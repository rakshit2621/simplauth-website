      ...
      <div className="flex-col justify-start items-start pl-4">
        ...
        <div className="flex flex-col gap-4 items-start justify-center">
          ...
          <div className="text-left text-md text-white-900">
            ...
            in manually if autologin fails. It prompts you to enter your
            username or email and password when you visit the website.
          </div>
          {/* ---------------------------------Autologin------------------------------------ */}
          ...
          <div className="flex flex-col gap-4 items-left justify-center">
            ...
            the Provider. Ensure that UserEmailPassPrisma is defined in the
            Prisma schemas. Then pass the Provider as a parameter to the
            Simplauth library.
          ...
          <div className="flex flex-col gap-4 items-left justify-center">
            ...
            credentials. The user must supply two things: email (or username)
            and password within the Provider. Keep the Provider exactly as
            shown, and send a request to the backend as demonstrated below.
            ...
            {` { message: "Invalid email or username", status: "failed" }`}. If
